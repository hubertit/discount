...
$title = urlencode('New order placed');
$body = urlencode("Dear Admin,<br>New order has been placed!<br>Order details are as follows:<br><br>Order ID: $orderId<br>Order Total: $cartTotal <br><br>Best regards,<br> Melartmart Ltd");
$receiverMail = "Discrountsinfo@gmail.com";
$receiverName = "Admin";
