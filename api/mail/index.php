...
//Username to use for SMTP authentication - use full email address for gmail
    $mail->Username = "no_reply@disscrounts.rw";

//Password to use for SMTP authentication
    $mail->Password = "~Au0qpIyHP7C";

//Set who the message is to be sent from
    $mail->setFrom('no_reply@disscrounts.rw', 'Discrounts');

//Set an alternative reply-to address
    $mail->addReplyTo('support@disscrounts.rw', 'Discrounts Support');
...
<div class='container'>
    ...
    <div class='footer'>
        &copy; 2024 Discrounts. All Rights <Reserved class=''></Reserved>
    </div>
</div>
</div>
</body>
