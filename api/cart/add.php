...
if ($cartItem) {
    ...
    $newQuantity = $cartItem['cart_qty'] + $quantity;
    ...
    $insertQuery = mysqli_query($connection, "INSERT INTO `carts` (`cart_id`, `session_id`, `customer_id`, `product_id`, `cart_qty`, `cart_total`, `cart_time`) 
    VALUES (NULL, NULL, '$userId', '$productId', '$quantity', '$total', CURRENT_TIMESTAMP)") or die(mysqli_error($connection));
}
