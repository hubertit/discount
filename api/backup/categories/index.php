...
$query = mysqli_query($connection, "SELECT * FROM categories WHERE parent_id =0 AND category_status!='deactivated' ORDER BY category_name ASC") or die(mysqli_error($connection));
