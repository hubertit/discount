...
if ($cartItem) {
    ...
    $deleteQuery = mysqli_query($connection, "DELETE FROM carts WHERE product_id='$productId' AND customer_id='$userId'") or die(mysqli_error($connection));
} else {
    $response = json_encode([
        'code' => 404,
        'status' => "Error",
...
$responseArray = array(
    'code' => 200,
    'status' => "Success",
    'message' => "You have successfully removed the product from the cart",
    'data' => array(
