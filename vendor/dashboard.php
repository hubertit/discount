                                ...
                                <div class="account-box">
                                    <div class="info">
                                        ...
                                        <p class="inv-balance">
                                            ...
                                            $query = mysqli_query($connection, "SELECT * FROM  products WHERE vendor_id ='$vendorId'") or die(mysqli_error($connection));
                                            $count = mysqli_num_rows($query);
                                            print number_format($count);
                                            ?>
                                        </p>
