                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <!-- <h3 class="">Container Status Update</h3> -->
                                    <?php require("scripts/main.php"); ?>

                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label>Container Status</label>
                                            <input type="hidden" name="container_id" value="<?php print $_GET["container"]; ?>">
                                            <textarea name="containerStatus" class="form-control">
                                                </textarea>
                                            <script>
                                                CKEDITOR.replace('containerStatus');
                                            </script>

                                        </div>
                                        <button class="btn btn-primary " type="submit" name="addContainerStatus">Save Update Status</button>
