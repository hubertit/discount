...
<head>
    ...
    <title>Slide Registration </title>
                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data" class="p-5">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Slide Name"
                                                       name="slideName" value="" required>
                                            </div>
                                        </div>
                                    ...
                                    <button class="btn btn-primary" type="submit" name="addSlide">Save Info</button>
                                </form>
                            </div>
                        </div>
                    </div>
