                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data">
                                    <h3 class="">Parcel Status Registration</h3>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            ...
                                            <input type="hidden" name="parcel_id" value="<?php print $_GET["parcel"]; ?>">
                                            <textarea name="parcelStatus" class="form-control">
                                                </textarea>
                                            <script>
                                                CKEDITOR.replace('parcelStatus');
                                            </script>

                                        </div>

                                        <button class="btn btn-primary " type="submit" name="addParcelStatus">Save Parcel Status Info</button>
