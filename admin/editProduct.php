                        ...
                        <div class="skills layout-spacing ">
                            <div class="widget-content widget-content-area">
                                <form action="" method="post" enctype="multipart/form-data" class="p-5">
                                    <h3 class="">Update Product Info</h3>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-12 ">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Product Name" name="productName" value="<?php print $product["product_name"]; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-lg-6 ">
                                            <div class="form-group">
                                                ...
                                                <input type="number" class="form-control" placeholder="Price [ RWF ]" name="productPrice" value="<?php print $product["product_price"]; ?>" required>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 ">
                                            <div class="form-group">

                                                <input type="number" class="form-control" placeholder="Discount Price [ RWF ]" name="discountPrice" value="<?php print $product["product_price"]; ?>" required>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <textarea name="productDescription" placeholder="Product Description" class="form-control" id="" cols="30" rows="5"><?php print $product["product_description"]; ?></textarea>
                                            </div>
                                        </div>
                                    ...
                                    <input type="hidden" name="productId" value="<?php print $product["product_id"]; ?>">
                                    <button class="btn btn-primary " type="submit" name="editProduct">Update Product</button>
                                </form>
                            </div>
                        </div>
                    </div>
