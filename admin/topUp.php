...
?>
    ...
    <head>
        ...
        <title>Top Up <?php print $customer["customer_fname"]; ?> <?php print $customer["customer_lname"]; ?>'s wallet </title>
                            ...
                            <div class="skills layout-spacing ">
                                <div class="widget-content widget-content-area">
                                    <form action="" method="post" enctype="multipart/form-data">
                                        <h3 class="">Top Up <?php print $customer["customer_fname"]; ?> <?php print $customer["customer_lname"]; ?>'s wallet</h3>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="rate" required placeholder="USD to Yuan">
                                                </div>
                                            </div>
                                        ...
                                        <button class="btn btn-primary " type="submit" name="topUp">Top Up Wallet</button>
                                    </form>
                                </div>
                            </div>
                        </div>
