                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-hover non-hover" style="width:100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($connection, "SELECT * FROM  parcel_statuses WHERE parcel_id ='$parcelId' ORDER BY status_id DESC") or die(mysqli_error($connection));
                                        $no = 0;
                                        while ($data = mysqli_fetch_assoc($query)) {
                                            ...
                                            <tr>
                                                ...
                                                <td><?php print(htmlspecialchars_decode($data["status"])); ?></td>
